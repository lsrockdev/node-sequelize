...
const adminSlotRoutes = require("./dashboard/admin_slot_routes");
const adminTempRoutes = require("./dashboard/admin_temp_routes");
...
router.use("/admin", adminSlotRoutes);
router.use("/admin", adminTempRoutes);
